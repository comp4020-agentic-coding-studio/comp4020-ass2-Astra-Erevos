...
description:
  Moving from isolated interactions to continuity — recurring pattern,
  one-off event, shared convention and uncertain history
week: 4
date: 2027-03-15
teachers:
  - marisol-quaye
...
pattern treated as uncertain produces one that feels forgetful.

## Why this matters now

Catwatch, due this week, is a log of observations. It is not yet a history,
because a log alone does not say which entries are recurring, which are
one-off, which are shared convention, and which are still uncertain. That
sorting is the work The Care Model asks for next — and it is exactly the
work this week's Care Lab showcase puts in front of the class before you
start building it.
